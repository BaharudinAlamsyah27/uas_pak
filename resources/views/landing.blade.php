...
<body>
  <div class="hero_area">
    ...
    <section class=" slider_section position-relative">
      <div class="slider_container">
        <div class="img-box">
          <img src="{{ asset('front_assets/images/hero-img.jpg') }}" alt="">
        </div>
  ...
  <section class="book_section">
          ...
          <div class="col-lg-8">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input type="text" name="pickup_location" class="form-control" placeholder="Location Name">
              </div>
              <div class="col-md-6">
                <label for="parkingNumber">Drop Location</label>
                <input type="text" name="drop_location" class="form-control" placeholder="Location Name">
              </div>
            </div>
            <div class="form-row">
              <div class="col-md-6">
    ...
    <div class="img-box">
      <img src="{{ asset('front_assets/images/book-car.png') }}" alt="">
    </div>
  </section>
  <section class="car_section layout_padding2-top layout_padding-bottom">
    <div class="container">
      ...
      <div class="car_container">
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/c-1.png') }}" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Choose Your Car
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/c-2.png') }}" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Get Your Car
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/c-3.png') }}" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Contact Your Dealer
  ...
  <section class="rent_section layout_padding">
    <div class="container">
      <div class="rent_container">
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/r-1.png') }}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/r-2.png') }}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/r-3.png') }}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/r-4.png') }}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/r-5.png') }}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/r-6.png') }}" alt="">
          </div>
          <div class="price">
            <a href="">
              Rent $200
          ...
          <div class="owl-carousel">
            <div class="item">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{ asset('front_assets/images/b-1.jpg') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Vintage
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{ asset('front_assets/images/b-2.jpg') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Steering wheels
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="img-box">
                  <img src="{{ asset('front_assets/images/b-3.jpg') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Buick Car
  ...
  <section class="us_section">
    ...
    <div class="us_container layout_padding2">
      <div class="content_box">
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/u-1.png') }}" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Low Rent
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/u-2.png') }}" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Fast Car
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/u-3.png') }}" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Safe Car
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/u-4.png') }}" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Quick Support
          ...
          <div class="owl-carousel">
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="{{ asset('front_assets/images/client-1.png') }}" alt="" class="img-1">
                    <img src="{{ asset('front_assets/images/client-1-white.png') }}" alt="" class="img-2">
                  </div>
                  <div class="name">
                    <h6>
                      Established
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="{{ asset('front_assets/images/client-2.png') }}" alt="" class="img-1">
                    <img src="{{ asset('front_assets/images/client-2-white.png') }}" alt="" class="img-2">
                  </div>
                  <div class="name">
                    <h6>
                      Blished
  ...
  <section class="contact_section layout_padding">
    <div class="container">
      ...
      <div class="contact_items">
        <a href="">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/location.png') }}" alt="">
          </div>
          <h6>
            Loram Ipusum ari
            lo elisant na
        ...
        <a href="">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/call.png') }}" alt="">
          </div>
          <h6>
            (+12 1234456789)
          </h6>
        ...
        <a href="">
          <div class="img-box">
            <img src="{{ asset('front_assets/images/mail.png') }}" alt="">
          </div>
          <h6>
            demo@gmail.com
          </h6>
      ...
      <div class="social_container">
        <div class="social-box">
          <div>
            <a href="">
              <img src="{{ asset('front_assets/images/fb.png') }}" alt="">
            </a>
          </div>
          <div>
            <a href="">
              <img src="{{ asset('front_assets/images/twitter.png') }}" alt="">
            </a>
          </div>
          <div>
            <a href="">
              <img src="{{ asset('front_assets/images/linkedin.png') }}" alt="">
            </a>
          </div>
          <div>
            <a href="">
              <img src="{{ asset('front_assets/images/insta.png') }}" alt="">
            </a>
          </div>
        </div>
      </div>
